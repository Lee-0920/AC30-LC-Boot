...
#define LAIRS485ADAPTER_DE_RE_SWITCH_PORT          GPIOB
#define LAIRS485ADAPTER_DE_RE_SWITCH_PIN           GPIO_Pin_13
#define LAIRS485ADAPTER_DE_RE_GPIO_CLK_CONFIG      RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOB, ENABLE)
